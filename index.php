...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		<h1 title="Dernier pièce de la collection chic dressing 2023 !" class="chic-title">Dernières pièces </h1>
		<?php
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 title="Retrouvez nous ici ! La fashionMap vous guidera." class="chic-title">La FashionMap - été 2022 </h2>
